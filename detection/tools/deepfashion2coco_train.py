...
for num in tqdm(range(1, num_images+1)):
    json_name = '/home/getgo/getgo_fashion/datasets/train/annos/' + str(num).zfill(6)+'.json'
    image_name = '/home/getgo/getgo_fashion/datasets/train/image/' + str(num).zfill(6)+'.jpg'
